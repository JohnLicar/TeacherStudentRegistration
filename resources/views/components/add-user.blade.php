  ...
  <div class="bg-white shadow-2xl m-4 sm:m-8" x-show="isDialogOpen" @click.away="isDialogOpen = false">
    ...
    <div class="p-2">
      ...
      <aside class="max-w-lg mt-4 p-4 bg-yellow-100 border border-yellow-500">
        <p>⚠ If you want to scope this modal to your entire app, you should apply the following directives to the
          &lt;body&gt; tag instead of &lt;main&gt; like I did here. Codepen doesn't seem to allow anything other than
          "class" in the &lt;body&gt; tag</p>
        <pre class="my-4">
